...
import {CreateNewAdminGroupForm} from './components/CreateNewAdminGroupForm';
...
const mapDispatchToProps = (dispatch): any => {
    return {
        ...
        onCreateNewSubmit: function(data: { name: string } ) {
        ...
        return (
            <section className='section-home container'>
                ...
                <Results waiting={loading}>
                    <ResultsHead />
                    <ResultsRow linkTo='admin/admin-groups' data={this.getData()}/>
                </Results>
