...
const SECTION_NAME: string = 'statuses';

export interface IStatusesAbstract {
    type: string;
}

export interface IStatusesRequest extends IStatusesAbstract {
    data: any;
}

export interface IStatusesResponse extends IStatusesAbstract {
    response?: any;
    success?: boolean;
    message?: string;
    hasError?: any;
...
export function onRequestAction(type: string, data?: any): IStatusesRequest {
    return {
        type,
        data
    };
