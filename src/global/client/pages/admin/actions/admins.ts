...
const SECTION_NAME: string = 'admins';

export interface IAdminsAbstract {
    type: string;
}

export interface IAdminsRequest extends IAdminsAbstract {
    data: any;
}

export interface IAdminsResponse extends IAdminsAbstract {
    response?: any;
    success?: boolean;
    message?: string;
    hasError?: any;
...
export function onRequestAction(type: string, data?: any): IAdminsRequest {
    return {
        type,
        data
    };
