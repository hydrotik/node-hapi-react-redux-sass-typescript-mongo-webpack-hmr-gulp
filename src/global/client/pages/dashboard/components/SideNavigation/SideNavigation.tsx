...
export class SideNavigation extends React.Component<ISideNavigationProps, ISideNavigationState> {
    ...
    public constructor(props: ISideNavigationProps) {
        super(props);
    }
                ...
                <ul className="sidebar-menu">
                  ...
                  <li className="treeview">
                    ...
                    <ul className="treeview-menu">
                      ...
                      <li>
                        <a href="#"><i className="fa fa-circle-o" /> Level One <i className="fa fa-angle-left pull-right" /></a>
                        <ul className="treeview-menu">
                          <li><a href="#"><i className="fa fa-circle-o" /> Level Two</a></li>
                          <li>
                            <a href="#"><i className="fa fa-circle-o" /> Level Two <i className="fa fa-angle-left pull-right" /></a>
                            <ul className="treeview-menu">
